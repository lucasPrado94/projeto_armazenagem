...
<head>
	...
	<title>Cadastro de Tipos de Armazenagem - Edição</title>
...
<body>
	   ...
	   <nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Editar Tipo de Armazenagem</strong> <a href="tipoArmVisualizar.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Buscar Tipos de Armazenagem</a></div>
			<div class="card-body">
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control" value="Saca" placeholder="Digite o Tipo do Grão aqui..." required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="peso" id="peso" class="form-control" value="60" placeholder="Digite o Tipo do Grão aqui..." required>
