...
<head>
	...
	<title>Cadastro de Grãos - Edição</title>
...
<body>
	   ...
	   <nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Editar Grão</strong> <a href="graoVisualizar.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Buscar Grãos</a></div>
			<div class="card-body">
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<label>Tipo do Grão <span class="text-danger">*</span></label>
                            <input type="text" name="tipoGrao" id="tipoGrao" class="form-control" value="Café" placeholder="Digite o Tipo do Grão aqui..." required>

						</div>

                        <div class="form-group">

							<label>Classe do Grão <span class="text-danger">*</span></label>
                            <input type="text" name="classe" id="classe" class="form-control" value="Bebida Mole" placeholder="Digite o Tipo do Grão aqui..." required>
