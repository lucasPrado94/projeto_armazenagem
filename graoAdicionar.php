...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Cadastro de Grão</strong> <a href="graoVisualizar.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Buscar Grãos</a></div>
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
                            ...
                            <input type="text" name="tipoGrao" id="tipoGrao" class="form-control" placeholder="Digite o Tipo do Grão aqui..." required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="classe" id="classe" class="form-control" placeholder="Digite a Classe do Grão aqui..." required>
