...
<head>
	...
	<title>Cadastro de Tipos de Armazenagem - Visualização</title>
...
<body>
	   ...
	   <nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="card">
			<div class="card-body">
				<div class="col-sm-12">
					<h5 class="card-title"><a href="tipoArmAdicionar.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Adicionar Tipo de Armazenagem</a></h5>
				</div>
			</div>
		<hr>
		<div>
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<tr>
						...
						<td>1</td>
						<td align="center">
							<a href="tipoArmEditar.php" class="text-primary"><i class="fa fa-fw fa-edit"></i> Editar</a> | 
