...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Cadastro de Funcionário</strong> <a href="funcionarioVisualizar.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Buscar Funcionários</a></div>
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<label>Selecione a pessoa que deseja cadastrar como funcionário <span class="text-danger">*</span></label>

							<select class="form-select" aria-label="Default select example">
                                <option selected>Selecione a Pessoa...</option>
						...
						<div class="form-group">
							...
							<label>Digite a Senha para o Funcionário <span class="text-danger">*</span></label>
                            
                            <input type="password" name="senha" id="senha" class="form-control" placeholder="Digite a senha aqui..." required>
